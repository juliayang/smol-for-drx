...
__author__ = "Luis Barroso-Luque, " \
             "Julia Yang (Tableswapper, Semigrandcanonicaltableswapper)," \
             "Tina Chen (Tableswapper)"
...
class Tableswapper(MCUsher):
    """
    Initialize Tableswapping algorithm from MCMCUsher base class.
    """

    def __init__(self, sublattices, Mn_flip_table, allow_crossover=True,
        ...
        self.Mn_flip_table = Mn_flip_table
...
class Semigrandcanonicaltableswapper(MCUsher):
    """
    Initialize Tableswapping algorithm from MCMCUsher base class.
    """
